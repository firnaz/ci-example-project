...
<div style="max-width:800px">
	<div class="col-md-10">
		...
		<h3 class="text-center">Untuk Pendaftaran Seminar Proposal</h3>
		<br><br>
		<div class="col-md-12">
		...
		<br><br><br><br><br>
		<div class="col-md-12">
			<div class="col-md-12">Menyatakan Mahasiswa tersebut diatas disetujui untuk pendaftaran seminar proposal.</div>
		</div>
		<br><br>
		<div class="col-md-12">
			<div class="col-xs-6 col-md-6"></div>
			<?php 
				$p1 = strtotime($Dosen1->tgl_proposal);
				$p2 = strtotime($Dosen2->tgl_proposal);
				$tgl = $p1>$p2?date("d-m-Y",$p1):date("d-m-Y",$p2);
			?>
