...
<div style="max-width:800px">
	<div class="col-md-10">
		...
		<h3 class="text-center">Untuk Pendaftaran Seminar Hasil</h3>
		<br><br>
		<div class="col-md-12">
		...
		<br><br><br><br><br>
		<div class="col-md-12">
			<div class="col-md-12">Menyatakan Mahasiswa tersebut diatas disetujui untuk pendaftaran seminar hasil.</div>
		</div>
		<br><br>
		<div class="col-md-12">
			<div class="col-xs-6 col-md-6"></div>
			<?php 
				$s1 = strtotime($Dosen1->tgl_seminar);
				$s2 = strtotime($Dosen2->tgl_seminar);
